...
mkdir /var/www/html
cd /var/www/html
wget https://github.com/Vanderlei-ctrl/SSHPLUS-MANAGER-FREE/blob/master/Install/Panel_Web/panel_v10/painel10.zip > /dev/null 2>&1
sleep 1
...
sleep 1
cd
wget https://raw.githubusercontent.com/Vanderlei-ctrl/SSHPLUS-MANAGER-FREE/master/Install/Panel_Web/panel_v10/plus.sql > /dev/null 2>&1
sleep 1
...
echo -e "\033[1;37mwget https://raw.githubusercontent.com/Vanderlei-ctrl/SSHPLUS-MANAGER-FREE/master/Install/Panel_Web/panel_v10/revenda/confpainel/inst > /dev/null 2>&1; bash inst\033[0m"
...
mkdir /var/www/html
cd /var/www/html
wget https://github.com/Vanderlei-ctrl/SSHPLUS-MANAGER-FREE/blob/master/Install/Panel_Web/panel_v11/PAINELWEB1.zip > /dev/null 2>&1
sleep 1
...
sleep 1
cd
wget https://raw.githubusercontent.com/Vanderlei-ctrl/SSHPLUS-MANAGER-FREE/master/Install/Panel_Web/panel_v11/sshplus.sql > /dev/null 2>&1
sleep 1
